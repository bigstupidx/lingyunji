...
{
    internal class StandardEyesBlackShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static string secondaryMapsText = "2 Maps";
        ...
        MaterialProperty giglossiness = null;
        MaterialProperty gidarkness = null;
        // MaterialProperty skincolor = null;
        // MaterialProperty clothcolor = null;
        MaterialProperty hues = null;
        MaterialProperty sats = null;
        MaterialProperty vals = null;
        MaterialProperty huec = null;
        MaterialProperty satc = null;
        MaterialProperty valc = null;
        ...
        MaterialProperty lightpos = null;
        MaterialProperty lightcol = null;
        MaterialProperty havedir = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            hues = FindProperty("_HueS",props,false);
            sats = FindProperty("_SatS",props,false);
            vals = FindProperty("_ValS",props,false);
            huec = FindProperty("_HueC",props,false);
            satc = FindProperty("_SatC",props,false);
            valc = FindProperty("_ValC",props,false);

            lightcol = FindProperty("_LColor",props,false);
            lightpos =  FindProperty("_WSLP",props,false);
            havedir = FindProperty("_DiectionHave",props,false);

            if (hues != null)
                m_WorkflowMode = WorkflowMode.Skin;
            else if (metallicMap != null && metallic != null && lightcol == null)
                m_WorkflowMode = WorkflowMode.Gloss;
            //if (specularMap != null && specularColor != null)
            //    m_WorkflowMode = WorkflowMode.Specular;
            else if (metallicMap != null && metallic != null && lightcol != null  )               
                m_WorkflowMode = WorkflowMode.LMap;
            else if (havedir != null)
                m_WorkflowMode = WorkflowMode.LMap20;
            ...
            giglossiness = FindProperty("_GiGlossiness", props);
            gidarkness = FindProperty("_GiDarkness", props);
        ...
        internal void DetermineWorkflow(MaterialProperty[] props)
        {
            ...
            {
                m_WorkflowMode = WorkflowMode.Metallic;
                if (FindProperty("_HueS", props, false) != null)
                    m_WorkflowMode = WorkflowMode.Skin;
                if(FindProperty("_WSLP",props,false) != null )
                    m_WorkflowMode = WorkflowMode.LMap;
                if(FindProperty("_DiectionHave",props,false)!= null)
                    m_WorkflowMode = WorkflowMode.LMap20;
                else 
                    m_WorkflowMode = WorkflowMode.Gloss;
            }
