    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_4213 = (((1.0 - _dissolve_amount)*1.35+-0.75)+_noise_var.r+(i.uv0.g*2.0+-1.0)+i.vertexColor.a);
                clip(node_4213 - 0.5);
...
/////// Diffuse:
                ...
                float node_3111 = (node_670+node_670+i.vertexColor.a);
                float3 diffuseColor = (_Main_color.rgb*node_3111*_self_Illumin*i.vertexColor.rgb);
...
/// Final Color:
                ...
                return fixed4(finalColor,node_3111);
            }
            ENDCG
        }
        Pass {
