    ...
    public class ColorCorrectionCurves : PostEffectsBase
	{
        ...
        public override bool CheckResources ()
		{
            ...
            if (simpleColorCorrectionCurvesShader == null)
                simpleColorCorrectionCurvesShader = Resources.Load("ColorCorrectionCurvesSimple",typeof(Shader)) as Shader;
            if (colorCorrectionCurvesShader == null)
                colorCorrectionCurvesShader = Resources.Load("ColorCorrectionCurves", typeof(Shader)) as Shader;
            if (colorCorrectionSelectiveShader == null)
                colorCorrectionSelectiveShader = Resources.Load("ColorCorrectionSelective", typeof(Shader)) as Shader;
