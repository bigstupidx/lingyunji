...
public class UIBasicSpriteEditor : UIWidgetInspector
{
	...
	protected override void DrawCustomProperties ()
	{
        ...
        else if (type == UISprite.Type.Polygon)
        {
            ...
            NGUIEditorTools.DrawProperty("  polygon", serializedObject, "mPolygonType");
            SerializedProperty pt = serializedObject.FindProperty("mPolygonType");
            if (pt.intValue == (int)UIBasicSprite.PolygonType.None)
            {
