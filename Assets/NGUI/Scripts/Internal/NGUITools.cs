...
static public class NGUITools
{
    ...
    static public void SetLayer(GameObject go, int layer, int depth)
    {
        ...
        {
            Transform child = t.GetChild(i);
            SetLayer(child.gameObject, layer, depth - 1);
        }
    }
    ...
    [System.NonSerialized]
    static bool mCheckedMainViewFunc = false;
    ...
    static public T Draw<T>(string id, OnInitFunc<T> onInit = null) where T : UIWidget
    {
        ...
        if (mRoot == null)
        {
            ...
            {
                mRoot = NGUITools.AddChild<UIPanel>(baseRoot.gameObject);
            }
