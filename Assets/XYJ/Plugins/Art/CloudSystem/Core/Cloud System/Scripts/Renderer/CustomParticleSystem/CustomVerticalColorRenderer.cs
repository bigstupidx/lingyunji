...
namespace Edelweiss.CloudSystem {
	...
	/// <summary>
	/// Generic base class of <see cref="T:CS_CustomVerticalColorRenderer"/>.
	...
	/// </typeparam>
	public abstract class CustomVerticalColorRenderer <C, PD, CD> : CustomCloudRenderer <C, PD, CD>
		...
		where CD : CreatorData <C, PD, CD>
	{
		...
		protected override void UpdateMesh (object a_State) {
			...
			for (int i = l_LeftIndex; i < l_RightIndex; i = i + 1) {
				...
				Color l_VertexColor1 = m_CloudRendererData.VerticalColorAt (l_HeightFactor1);
				Color l_VertexColor2 = m_CloudRendererData.VerticalColorAt (l_HeightFactor2);
				Color l_VertexColor3 = m_CloudRendererData.VerticalColorAt (l_HeightFactor3);
				Color l_VertexColor4 = m_CloudRendererData.VerticalColorAt (l_HeightFactor4);
