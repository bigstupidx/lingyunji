...
namespace Edelweiss.CloudSystem {
	...
	/// <summary>
	/// Generic base class of <see cref="T:CS_ShurikenVerticalColorRenderer"/>.
	...
	/// </typeparam>
	public abstract class ShurikenVerticalColorRenderer <C, PD, CD> : ShurikenCloudRenderer <C, PD, CD>
