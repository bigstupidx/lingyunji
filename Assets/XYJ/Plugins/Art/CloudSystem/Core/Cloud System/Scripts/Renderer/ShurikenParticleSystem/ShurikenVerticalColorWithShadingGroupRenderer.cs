...
namespace Edelweiss.CloudSystem {
	...
	/// <summary>
	/// Generic base class of <see cref="T:CS_ShurikenVerticalColorWithShadingGroupRenderer"/>.
	...
	/// </typeparam>
	public abstract class ShurikenVerticalColorWithShadingGroupRenderer <C, PD, CD> : ShurikenCloudRenderer <C, PD, CD>
