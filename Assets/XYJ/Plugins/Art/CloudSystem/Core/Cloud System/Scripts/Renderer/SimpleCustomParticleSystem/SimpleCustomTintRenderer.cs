...
namespace Edelweiss.CloudSystem {
	...
	/// <summary>
	/// Generic base class of <see cref="T:CS_SimpleCustomTintRenderer"/>.
	...
	/// </typeparam>
	public abstract class SimpleCustomTintRenderer <C, PD, CD> : SimpleCustomCloudRenderer <C, PD, CD>
		...
		where CD : CreatorData <C, PD, CD>
	{
		...
		protected override void UpdateParticleColors (object a_State) {
			...
			for (int i = l_LeftIndex; i < l_RightIndex; i = i + 1) {
				...
				Color l_Color = m_CloudRendererData.Tint;
