...
namespace Edelweiss.CloudSystem {
	...
	/// <summary>
	/// Generic base class of <see cref="T:CS_UnityParticleSystemShadingGroupRenderer"/>.
	...
	/// </typeparam>
	public abstract class UnityParticleSystemShadingGroupRenderer <C, PD, CD> : UnityParticleSystemCloudRenderer <C, PD, CD>
