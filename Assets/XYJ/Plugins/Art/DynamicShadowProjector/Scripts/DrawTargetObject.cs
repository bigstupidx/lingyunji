...
namespace DynamicShadowProjector
{
    ...
    public class DrawTargetObject : MonoBehaviour
    {
            ...
            if (m_renderChildren)
            {
                ...
                for (int i = -1; i < materialCount; ++i)
                {
                    foreach (Renderer renderer in renderers)
                    {
                        ...
                        {
                            SkinnedMeshRenderer meshR = renderer as SkinnedMeshRenderer;
                            if (meshR != null && meshR.sharedMesh == null)
                                continue;
        ...
        public void UpdateTransform()
        {
            ...
            Transform dir = m_targetDirection != null ? m_targetDirection : TargetDirection.target;
            if (m_textureAlignment != TextureAlignment.None || dir != null)
            {
                ...
                Vector3 z = dir != null ? dir.forward : transform.forward;
        ...
        void AddDrawCommand(Renderer renderer, int renderTypeIndex)
        {
            ...
            for (int i = 0; i < materials.Length; ++i)
            {
                ...
                if(m==null)
                {
                    Debug.LogError(string.Format("材质为null path={0}", GetFullPath(renderer.transform)));
                    continue;
                }
