...
namespace DynamicShadowProjector {
	...
	public class ShadowTextureRenderer : MonoBehaviour {
		...
		[SerializeField]
        [PackTool.Pack]
        public Material m_blurShader;

		[SerializeField]
        [PackTool.Pack]
        public Material m_downsampleShader;
		
        [SerializeField]
        [PackTool.Pack]
        public Material m_copyMipmapShader;
		
        [SerializeField]
        [PackTool.Pack]
		public Material m_eraseShadowShader;
		...
		void SetVisible(bool isVisible)
		{
			...
			SendMessage("OnVisibilityChanged", isVisible,SendMessageOptions.DontRequireReceiver);
		}
