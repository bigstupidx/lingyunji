...
namespace PigeonCoopToolkit.Effects.Trails.Editor
{
    ...
    public class TrailEditor_Base : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.BeginHorizontal();
            EditorGUILayout.PropertyField(serializedObject.FindProperty("TrailData.UseCustomRenderQueue"));
            if (t.TrailData.UseCustomRenderQueue)
            {
                EditorGUILayout.PropertyField(serializedObject.FindProperty("TrailData.renderQueue"));
			...
			EditorGUILayout.PropertyField(serializedObject.FindProperty("FollowRootPosition"));
			EditorGUILayout.PropertyField(serializedObject.FindProperty("FollowRootRotation"));
