...
/// <summary>
/// ProFlare.cs
/// Holds the definition of a flares and all of its features.
/// </summary>
...
public class ProFlare : MonoBehaviour {
	...
	//public Color32 black32 = new Color32(0,0,0,0);
	
	//public List<Transform> ExtraSources = new List<Transform>();
