...
namespace WXB
{
    ...
    public class SymbolTextEvent : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        public OnClickEvent OnClickWithoutDragging = new OnClickEvent();
        [SerializeField]
        public class OnClickEmptyEvent : UnityEvent { }
        public OnClickEmptyEvent OnClickEmpty = new OnClickEmptyEvent(); // 点击非Node节点时事件
        void OnEnable()
        {
        ...
        public void OnPointerUp(PointerEventData eventData)
        {
            ...
            if(d_down_basedata != null)
            {
                ...
                {
                    OnClickWithoutDragging.Invoke(d_down_basedata.node);
                }
            }
