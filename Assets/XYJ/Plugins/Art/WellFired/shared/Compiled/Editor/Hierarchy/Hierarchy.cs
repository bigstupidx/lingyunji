...
namespace WellFired.Shared
{
	...
	public class Hierarchy 
	{
		...
		public void OnGUI()
		{
			...
			using(var scrollView = new WellFired.Shared.GUIBeginScrollView(scrollPos, false, true, GUIStyle.none, GUI.skin.verticalScrollbar))
			{
		...
		private void DrawEntry(IHierarchyItem entry)
		{
			...
			using(new WellFired.Shared.GUIBeginArea(entry.RenderRect))
