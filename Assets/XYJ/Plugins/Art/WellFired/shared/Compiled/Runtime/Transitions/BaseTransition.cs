...
namespace WellFired.Shared
{
	public class BaseTransition 
	{
		...
		public void ProcessEventFromNoneOnGUI(float deltaTime, float duration)
		{
			...
			for(int cameraIndex = 0; cameraIndex < additionalSourceCameras.Count; cameraIndex++)
			{
			...
			for(int cameraIndex = 0; cameraIndex < additionalDestinationCameras.Count; cameraIndex++)
			{
