...
namespace WellFired
{
	...
	public class USAnimationTimelineHierarchyItem : IUSTimelineHierarchyItem
	{
		...
		{
            var animator = USTimelineAnimation.GetAnimator(AnimationTimeline.AffectedObject);
		...
		{
            if (AnimationTimeline == null || AnimationTimeline.AnimationTracks == null)
                return;

            AnimationTimeline.AnimationTracks.RemoveAll((AnimationTrack track) => { return track == null; });
