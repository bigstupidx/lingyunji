...
namespace WellFired
{
	public static class USPropertyMemberUtility 
	{
		...
		private static Dictionary<Type, List<string>> IgnoreList = new Dictionary<Type, List<string>>()
		{
			...
			{ typeof(AudioListener),  	new List<string>() { "volume", "pause" } },
			{ typeof(ParticleSystem), 	new List<string>() { "playbackspeed", "enableemission", "emissionrate", "maxparticles" } },
			{ typeof(Rigidbody2D), 		new List<string>() { "position", "rotation", "velocity", "angularvelocity", "centerofmass", "inertia", "simulated", } },
			{ typeof(Animator), 		new List<string>() { "rootposition", "rootrotation", "bodyposition", "bodyrotation", "stabilizefeet", "feetpivotactive", "speed", "playbacktime", "recorderstarttime", "recorderstoptime", "layersaffectmasscenter", "logwarnings", "fireevents" } },
