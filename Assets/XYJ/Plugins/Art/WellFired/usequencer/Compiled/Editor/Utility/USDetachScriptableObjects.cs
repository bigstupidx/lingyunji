	...
	public class USDetachScriptableObjects : EditorWindow 
	{
		...
		public static void ProcessPropertyTimeline(USTimelineProperty propertyTimeline)
		{
			...
			for(int n = 0; n < propertyTimeline.Properties.Count; n++)
			{
                ...
                usPropertyInfo.ComponentType = propertyTimeline.Properties[n].ComponentType;
                ...
                usPropertyInfo.propertyName = propertyTimeline.Properties[n].propertyName;
                usPropertyInfo.fieldName = propertyTimeline.Properties[n].fieldName;
