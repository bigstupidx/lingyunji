...
namespace WellFired
{
	...
	public class USTimelineProperty : USTimelineBase
	{
		...
		{
			if(propertyInfo.Component != null && propertyInfo.propertyName != null && ContainsProperty(propertyInfo.propertyName, propertyInfo.Component))
				throw new Exception("Cannot Add a property that we already have");
			
			if(propertyInfo.Component != null && propertyInfo.fieldName != null && ContainsProperty(propertyInfo.fieldName, propertyInfo.Component))
