...
public class XffectEventCustom : Editor 
{
    ...
    protected SerializedProperty BDBlurSize;
    protected SerializedProperty BDDistortTexture;
    protected SerializedProperty BDDistortTextureScale;
    protected SerializedProperty BDDistortIntensity;
    protected SerializedProperty BDTargetOutlineWidth;
	...
	void InitSerializedProperty()
	{
        ...
        BDBlurSize= serializedObject.FindProperty("BDBlurSize");
        BDDistortTexture = serializedObject.FindProperty("BDDistortTexture");
        BDDistortTextureScale = serializedObject.FindProperty("BDDistortTextureScale");
        BDDistortIntensity = serializedObject.FindProperty("BDDistortIntensity");
        BDTargetOutlineWidth = serializedObject.FindProperty("BDTargetOutlineWidth");
    ...
    void DrawBlurryDistortion() {
        if (Script.BlurryDistortionShader == null) {
            Script.BlurryDistortionShader = Shader.Find("Hidden/Eyesblack/Image Effects/BlurryDistortion");
        }

 
        XEditor.DrawSlider("blur size:", "", BDBlurSize, 0f, 10f);
        XEditor.DrawTexture("distort texture:", "", BDDistortTexture);
        XEditor.DrawFloat("distort tex scale:", "", BDDistortTextureScale);
        XEditor.DrawSlider("distort intensity:", "", BDDistortIntensity, 0f, 0.05f);

        XEditor.DrawSeparator();
        XEditor.DrawSlider("target outline width:", "", BDTargetOutlineWidth, 0f, 0.5f);
    }
	...
	void DrawCameraEffectConfig()
	{
        ...
        {
            DrawGlitch();
        } else if ((CameraEffectEvent.EType)CameraEffectType.enumValueIndex == CameraEffectEvent.EType.BlurryDistortion) {
            DrawBlurryDistortion();
        }
		XEditor.EndXArea();
	}
