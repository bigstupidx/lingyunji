...
namespace Xft
{
    ...
    public class XftEventComponent : MonoBehaviour, IEffectBaseEvent
    {
        //deprecated
        ...
        [PackTool.Pack]
        public Shader BlurryDistortionShader;
        public float BDBlurSize = 1.5f;
        [PackTool.Pack]
        public Texture2D BDDistortTexture;
        public float BDDistortTextureScale = 10;
        public float BDDistortIntensity = 0.01f;
        public float BDTargetOutlineWidth = 0.05f;
        public float BDSampleStrength = 1f;
        ...
        public static System.Action<XftEventComponent, object> _PlayEvent_ = null;

        public void PlayEvent(IEffectManage effectmanage)
        {
            CallerGo = effectmanage.gameObject;
        ...
        //²¥·ÅÊÂ¼þ
        //public void PlayEvent(AnimationEffectManage effectmanage) {
        //    CallerGo = effectmanage.gameObject;
        //    if (m_eventHandler != null) {
        //        m_eventHandler.PlayEvent();
        //    }
        ...
        public void Initialize( XffectComponent owner)
        {
            ...
            switch (Type)
            {
                ...
                case XEventType.CameraEffect:
                    ...
                    } else if (CameraEffectType == CameraEffectEvent.EType.BlurryDistortion) {
                        m_eventHandler = new BlurryDistortionEvent(this);
                    }
                    break;
        ...
        //        m_eventHandler.SetAble(true);
        //}

        void OnDisable()
        {
            if (null != m_eventHandler)
                m_eventHandler.SetAble(false);
        }
    }
}