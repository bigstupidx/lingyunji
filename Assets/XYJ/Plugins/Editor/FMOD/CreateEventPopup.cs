...
namespace FMODUnity
{
    class CreateEventPopup : EditorWindow
    {
        ...
        public void OnGUI()
        {
            var borderIcon = EditorUtils.Load<Texture2D>("FMOD/Border.png");
            ...
            var arrowIcon = EditorUtils.Load("FMOD/ArrowIcon.png") as Texture;
            var hoverIcon = EditorUtils.Load("FMOD/SelectedAlt.png") as Texture2D;
            var titleIcon = EditorUtils.Load("IN BigTitle") as Texture2D;
