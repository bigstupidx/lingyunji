...
namespace FMODUnity
{
    ...
    class EditorUtils : MonoBehaviour
    {
        ...
        {
            return AssetDatabase.LoadAssetAtPath<T>("Assets/Plugins/Editor/Editor Default Resources/" + assetPath);
        }

        public static UnityEngine.Object Load(string assetPath)
        {
            return AssetDatabase.LoadAssetAtPath("Assets/Plugins/Editor/Editor Default Resources/" + assetPath, typeof(UnityEngine.Object));
        }
