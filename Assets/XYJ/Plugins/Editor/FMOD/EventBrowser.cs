    ...
    class EventBrowser : EditorWindow, ISerializationCallbackReceiver
    {
        ...
        void ShowEventFolder(TreeItem item, Predicate<TreeItem> filter)
        {
            ...
            if (item.EventRef != null)
            {
                ...
                eventStyle.normal.background = selectedItem == item ? EditorUtils.Load<Texture2D>("FMOD/Selected.png") : null;
        ...
        void OnGUI()
        {
            ...
            //if (eventStyle == null)
            {
                ...
                eventIcon = EditorUtils.Load<Texture>("FMOD/EventIcon.png");
                folderOpenIcon = EditorUtils.Load<Texture>("FMOD/FolderIconOpen.png");
                folderClosedIcon = EditorUtils.Load<Texture>("FMOD/FolderIconClosed.png");
                searchIcon = EditorUtils.Load<Texture>("FMOD/SearchIcon.png");
                bankIcon = EditorUtils.Load<Texture>("FMOD/BankIcon.png");
                snapshotIcon = EditorUtils.Load<Texture>("FMOD/SnapshotIcon.png");
                borderIcon = EditorUtils.Load<Texture2D>("FMOD/Border.png");
            }
        ...
        private void PreviewEvent(Rect previewRect, EditorEventRef selectedEvent)
        {
            ...
            var copyIcon = EditorUtils.Load<Texture>("FMOD/CopyIcon.png");
            ...
            Texture playOff = EditorUtils.Load<Texture>("FMOD/TransportPlayButtonOff.png");
            Texture playOn = EditorUtils.Load<Texture>("FMOD/TransportPlayButtonOn.png");
            Texture stopOff = EditorUtils.Load<Texture>("FMOD/TransportStopButtonOff.png");
            Texture stopOn = EditorUtils.Load<Texture>("FMOD/TransportStopButtonOn.png");
            Texture openIcon = EditorUtils.Load<Texture>("FMOD/transportOpen.png");
            ...
            {
                Texture circle = EditorUtils.Load<Texture>("FMOD/preview.png");
                Texture circle2 = EditorUtils.Load<Texture>("FMOD/previewemitter.png");
            ...
            Texture meterOn = EditorUtils.Load<Texture>("FMOD/LevelMeter.png");
            Texture meterOff = EditorUtils.Load<Texture>("FMOD/LevelMeterOff.png");
