...
{    
    ...
    class EventRefDrawer : PropertyDrawer
    {
        ...
        {
            Texture browseIcon = EditorUtils.Load("FMOD/SearchIconBlack.png") as Texture;
            Texture openIcon = EditorUtils.Load("FMOD/BrowserIcon.png") as Texture;
            Texture addIcon = EditorUtils.Load("FMOD/AddIcon.png") as Texture;
            ...
            else
            {
                ...
                GUI.Label(labelRect, new GUIContent("Event Not Found", EditorUtils.Load("FMOD/NotFound.png") as Texture2D));
            }
