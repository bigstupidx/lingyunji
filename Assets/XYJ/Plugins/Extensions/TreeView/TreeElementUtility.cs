...
{
    public class TreeElementUtility : MonoBehaviour
    {

        /// <summary>
        /// Parse the root of the tree to a list.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="root"></param>
        /// <param name="result"></param>
        public static void TreeToList<T>(T root, ref IList<T> result) where T : TreeElement
        {
            if (result == null)
