...
namespace EditorExtensions
{
    ...
    public class TreeViewWithTreeModel<T> : TreeView where T : TreeElement
    {
        ...
        public event Action treeChanged;// Tree Changed Event
        public event Action<IList<TreeViewItem>> beforeDroppingDraggedItems;// Drag Items Event
