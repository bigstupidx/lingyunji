...
{
    public class StoryEventPlayCG : StoryEventBase
    {
        ...
        public override void OnFire()
        {
            ...
            StoryEventDataParam data = eventData as StoryEventDataParam;
            if (string.IsNullOrEmpty(data.m_param))
                return;
            USPlayCG.PlayCGById(data.m_param, () => { Resume(); });
            if (USPlayCG.IsCGPlaying)
                Pause();
        }
        ...
        public override void OnStop()
        {
            ...
            if (USPlayCG.Current!=null)
                USPlayCG.Current.PassCG();
        }
    }
}
