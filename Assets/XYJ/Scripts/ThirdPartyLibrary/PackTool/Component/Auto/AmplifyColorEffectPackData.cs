...
namespace PackTool
{
    public class AmplifyColorEffectPackData : ComponentData
    {
#if UNITY_EDITOR
        // 收集此组件的数据
        ...
        {
            bool has = false;
            AmplifyColorEffect com = component as AmplifyColorEffect;
        ...
        static void LoadTextureEnd(Texture texture, object p)
        {
            ...
            int index = (int)pp[1];
            AmplifyColorEffect com = data.mComponent as AmplifyColorEffect;
            switch (index)
            {
