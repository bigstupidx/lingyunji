...
namespace PackTool
{
    public class BloomBasePackData : ComponentData
    {
#if UNITY_EDITOR
        // 收集此组件的数据
        ...
        {
            bool has = false;
            UnityStandardAssets.ImageEffects.BloomBase com = component as UnityStandardAssets.ImageEffects.BloomBase;
        ...
        static void LoadTextureEnd(Texture texture, object p)
        {
            ...
            int index = (int)pp[1];
            UnityStandardAssets.ImageEffects.BloomBase com = data.mComponent as UnityStandardAssets.ImageEffects.BloomBase;
            switch (index)
            {
