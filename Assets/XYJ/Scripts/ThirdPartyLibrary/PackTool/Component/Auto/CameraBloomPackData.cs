...
namespace PackTool
{
    public class CameraBloomPackData : ComponentData
    {
#if UNITY_EDITOR
        // 收集此组件的数据
        ...
        {
            bool has = false;
            UnityStandardAssets.ImageEffects.CameraBloom com = component as UnityStandardAssets.ImageEffects.CameraBloom;
        ...
        static void LoadTextureEnd(Texture texture, object p)
        {
            ...
            int index = (int)pp[1];
            UnityStandardAssets.ImageEffects.CameraBloom com = data.mComponent as UnityStandardAssets.ImageEffects.CameraBloom;
            switch (index)
            {
