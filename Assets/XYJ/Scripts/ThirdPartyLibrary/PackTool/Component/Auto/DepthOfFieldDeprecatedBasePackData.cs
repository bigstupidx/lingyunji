...
namespace PackTool
{
    public class DepthOfFieldDeprecatedBasePackData : ComponentData
    {
#if UNITY_EDITOR
        // 收集此组件的数据
        ...
        {
            bool has = false;
            UnityStandardAssets.ImageEffects.DepthOfFieldDeprecatedBase com = component as UnityStandardAssets.ImageEffects.DepthOfFieldDeprecatedBase;
        ...
        static void LoadShaderEnd(Shader shader, object p)
        {
            ...
            int index = (int)pp[1];
            UnityStandardAssets.ImageEffects.DepthOfFieldDeprecatedBase com = data.mComponent as UnityStandardAssets.ImageEffects.DepthOfFieldDeprecatedBase;
            switch (index)
            {
