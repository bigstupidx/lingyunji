...
namespace PackTool
{
    public class DepthOfFieldDeprecatedPackData : ComponentData
    {
#if UNITY_EDITOR
        // 收集此组件的数据
        ...
        {
            bool has = false;
            UnityStandardAssets.ImageEffects.DepthOfFieldDeprecated com = component as UnityStandardAssets.ImageEffects.DepthOfFieldDeprecated;
        ...
        static void LoadShaderEnd(Shader shader, object p)
        {
            ...
            int index = (int)pp[1];
            UnityStandardAssets.ImageEffects.DepthOfFieldDeprecated com = data.mComponent as UnityStandardAssets.ImageEffects.DepthOfFieldDeprecated;
            switch (index)
            {
