...
namespace PackTool
{
    public class GhostEffectPackData : ComponentData
    {
#if UNITY_EDITOR
        // 收集此组件的数据
        ...
        {
            bool has = false;
            Eyesblack.FX.GhostEffect com = component as Eyesblack.FX.GhostEffect;
        ...
        static void LoadMaterialEnd(Material mat, object p)
        {
            ...
            int index = (int)pp[1];
            Eyesblack.FX.GhostEffect com = data.mComponent as Eyesblack.FX.GhostEffect;
            switch (index)
            {
