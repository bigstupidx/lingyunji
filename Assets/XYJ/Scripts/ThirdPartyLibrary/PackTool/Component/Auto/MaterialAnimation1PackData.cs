...
namespace PackTool
{
    public class MaterialAnimation1PackData : ComponentData
    {
#if UNITY_EDITOR
        // 收集此组件的数据
        ...
        {
            bool has = false;
            MaterialAnimation1 com = component as MaterialAnimation1;
        ...
        static void LoadMaterialEnd(Material mat, object p)
        {
            ...
            int index = (int)pp[1];
            MaterialAnimation1 com = data.mComponent as MaterialAnimation1;
            switch (index)
            {
