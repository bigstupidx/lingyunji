...
namespace PackTool
{
    public class MaterialAnimationPackData : ComponentData
    {
#if UNITY_EDITOR
        // 收集此组件的数据
        ...
        {
            bool has = false;
            MaterialAnimation com = component as MaterialAnimation;
        ...
        static void LoadMaterialEnd(Material mat, object p)
        {
            ...
            int index = (int)pp[1];
            MaterialAnimation com = data.mComponent as MaterialAnimation;
            switch (index)
            {
